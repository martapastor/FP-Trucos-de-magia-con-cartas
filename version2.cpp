...
void mostrarMontones (tMazo montonUno, tMazo montonDos, tMazo montonTres);
...
int main () {
	...
	while (opcionMenu != 0) {
		if (opcionMenu == 1) {
			...
			tMazo monton;
			repartirIntercalando (mazo, 3, 1, monton);
			cout << "Montón 1:" << endl;
			mostrar (monton);
			repartirIntercalando (mazo, 3, 2, monton);
			cout << "\nMontón 2:" << endl;
			mostrar (monton);
			repartirIntercalando (mazo, 3, 3, monton);
			cout << "\nMontón 3:" << endl;
			mostrar (monton);
		}
		else if (opcionMenu == 9) {
			cout << "REPARTIR DE MANERA ALTERNA EN 4 MONTONES" << endl << endl;
			tMazo monton;
			repartirIntercalando (mazo, 4, 1, monton);
			cout << "Montón 1:" << endl;
			mostrar (monton);
			repartirIntercalando (mazo, 4, 2, monton);
			cout << "\nMontón 2:" << endl;
			mostrar (monton);
			repartirIntercalando (mazo, 4, 3, monton);
			cout << "\nMontón 3:" << endl;
			mostrar (monton);
			repartirIntercalando (mazo, 4, 4, monton);
			cout << "\nMontón 4:" << endl;
			mostrar (monton);
		}
		opcionMenu = menu ();
